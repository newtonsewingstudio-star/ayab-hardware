...
The five connectors without LCSC identifiers are J403/J405 `HNC2-2.5P-10DS(02)`, J404 `HNC2-2.5P-8DS(55)`, J408 `HNC2-2.5P-3DS(02)`, and the non-KH910 J406 `A2506WV-10P`. For the KH910 prototype, J403/J404/J405/J408 must be sourced by these controlled MPNs and either consigned to the assembler or installed afterward. The available tin-plated `(55)` Hirose part is the approved Rev A prototype choice for J404; its official HNC geometry matches the prior `(02)` gold-plated part. A generic 2.5 mm header remains prohibited because mating and housing geometry are part of the machine interface. J406 may remain part of the general multi-machine population, but it is not a KH910 mating connector.
